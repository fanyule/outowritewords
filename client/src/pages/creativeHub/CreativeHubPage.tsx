...
export default function CreativeHubPage() {
  ...
  return (
    <div className="mx-auto max-w-[1680px] space-y-6">
      ...
      <div className="app-warning-panel flex items-start gap-2.5 rounded-[18px] border px-4 py-3.5 text-sm">
        <AlertTriangle className="mt-0.5 h-4 w-4 shrink-0" aria-hidden="true" />
        <div>
          <div className="font-medium">待完善</div>
          <div className="mt-1 app-caption-copy text-inherit">当前模块还在开发中，尚未完善；可先用于创作问题诊断、方案讨论和轻量推进。</div>
        </div>
      </div>

      <div className="grid min-h-[72vh] gap-6 lg:h-[calc(100vh-11rem)] lg:grid-cols-[260px_minmax(0,1fr)_340px]">
