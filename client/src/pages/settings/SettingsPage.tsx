...
import GraphEngineRuntimeSettingsCard from "./components/GraphEngineRuntimeSettingsCard";
...
export default function SettingsPage() {
  ...
  return (
    <div className={`${AUTO_DIRECTOR_MOBILE_CLASSES.settingsPageRoot} mx-auto flex w-full max-w-7xl flex-col gap-6`}>
      <DesktopUpdateCard />
      <DesktopLegacyDataImportCard forceVisible />

      <SettingsNavigationCards />
      <GraphEngineRuntimeSettingsCard />
      <StyleEngineRuntimeSettingsCard />

      <AutoDirectorSettingsSection onActionResult={setActionResult} />

      <Card className="app-hero-panel min-w-0 overflow-hidden">
        ...
        <CardContent className="grid min-w-0 gap-3 md:grid-cols-2">
          {providerConfigs.map((item) => {
            ...
            return (
              <div
                key={item.provider}
                className={`min-w-0 rounded-xl border p-4 shadow-[var(--app-card-shadow)] transition-colors ${
                  item.isConfigured
                    ? "border-primary/35 bg-primary/10"
                    : "border-border/65 bg-card/62"
                }`}
              >
                <div className="mb-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <Badge
                    ...
                    className={item.isConfigured ? "bg-emerald-500/90 text-white hover:bg-emerald-500/90" : ""}
                  >
                ...
                />
                <div className="mb-3 flex flex-col gap-3 rounded-xl border border-border/65 bg-card/68 px-3 py-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="min-w-0 space-y-1">
                ...
                <div className="app-state-panel-muted mb-3 rounded-xl p-3">
                  {item.kind === "custom" ? (
