...
export default function NovelBasicInfoForm(props: NovelBasicInfoFormProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="app-state-panel-muted rounded-2xl p-4">
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows={4}
            className="min-h-[112px] w-full rounded-xl border border-border/70 bg-background/75 px-3 py-2 text-sm outline-none transition focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50"
        ...
        <div className="app-shell-panel-soft rounded-xl p-3 text-sm leading-6 text-muted-foreground">
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          <div className="space-y-2">
            ...
            <select
              id="basic-genre"
              className="w-full rounded-xl border border-border/70 bg-background/75 p-2 text-sm"
