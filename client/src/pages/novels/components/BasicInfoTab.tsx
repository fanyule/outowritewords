...
export default function BasicInfoTab(props: BasicTabProps) {
  return (
    <div className="space-y-4">
      ...
      />
      <Card className="app-shell-panel border-0 shadow-none">
        <CardHeader className="border-b border-border/60 px-6 pb-4 pt-6">
      ...
      <details className="app-shell-panel-soft group p-4">
