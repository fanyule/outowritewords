...
export default function NovelCreate() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <Card className="overflow-hidden border-white/10 bg-[radial-gradient(circle_at_top,_rgba(22,93,255,0.14),_rgba(8,15,30,0.96)_62%)] shadow-[0_24px_56px_rgba(4,10,24,0.34)]">
        <CardHeader className="app-page-header border-b border-white/8 p-5 sm:p-6">
