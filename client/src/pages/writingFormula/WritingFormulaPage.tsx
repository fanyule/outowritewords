...
export default function WritingFormulaPage() {
  ...
  return (
    <div className="mobile-route-style-engine flex h-full min-h-0 flex-col gap-5">
      <div className="app-shell-panel px-5 py-5 md:px-6 md:py-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-3">
            <div className="app-section-kicker">Style Engine V2</div>
            <div className="space-y-2">
              <div className="app-heading-display text-foreground">写法引擎</div>
              <div className="app-reading-copy max-w-3xl text-muted-foreground">
                把写法资产、应用测试和去 AI 修订拆开管理，让这一页更像稳定可复用的创作工具，而不是临时工作面板。
              </div>
            </div>
          </div>
      ...
      {message ? (
        <div className="app-state-panel-muted px-4 py-3 text-sm text-muted-foreground">
          {message}
        </div>
      ) : null}
      ...
      >
        <DialogContent ref={editorDialogRef} className="app-modal-surface !flex h-[88vh] w-[min(1180px,96vw)] max-w-none flex-col gap-0 overflow-hidden border p-0">
          <DialogHeader className="app-shell-divider border-b px-6 py-5 pr-14">
          ...
          <div className="app-shell-grid h-full min-h-0 overflow-hidden p-6 pt-4">
      ...
      >
        <DialogContent className="app-modal-surface !flex h-[84vh] w-[min(1080px,94vw)] max-w-none flex-col gap-0 overflow-hidden border p-0">
          <DialogHeader className="app-shell-divider border-b px-6 py-5 pr-14">
          ...
          <div className="app-shell-grid h-full min-h-0 overflow-auto p-6 pt-4">
      ...
      >
        <DialogContent className="app-modal-surface !flex h-[84vh] w-[min(980px,92vw)] max-w-none flex-col gap-0 overflow-hidden border p-0">
          <DialogHeader className="app-shell-divider border-b px-6 py-5 pr-14">
