  ...
  return (
    <Card className="app-shell-panel-soft shadow-none">
      <CardHeader className="gap-2 pb-1">
        ...
        <CardTitle className="text-[1.75rem] leading-none tracking-tight">{pending ? "--" : value}</CardTitle>
        <div className="app-caption-copy">{hint}</div>
      </CardHeader>
    </Card>
  );
}
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <Card className="app-hero-panel overflow-hidden">
        <CardHeader className="app-page-header border-b border-border/70 p-5 sm:p-6">
          <div className="flex flex-wrap items-center gap-2">
            <Badge>新手推荐</Badge>
            <Badge variant="outline">低门槛开书</Badge>
          </div>
          <CardTitle className="app-heading-display max-w-4xl">
            {hasNovels ? "想快速开启下一本书？先交给 AI 自动导演。" : "第一次使用？先让 AI 自动导演带你开一本书。"}
          </CardTitle>
          <CardDescription className="app-reading-copy max-w-4xl">
      ...
      <Card className="app-shell-panel overflow-hidden">
          ...
          {novelQuery.isPending ? (
            ...
            <div className="space-y-4">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="space-y-3">
                  <div>
                    <div className="app-heading-section text-[1.8rem]">{primaryNovel.title}</div>
                  ...
                  <div className="app-reading-copy max-w-3xl">
            ...
            <div className="space-y-3">
              <div className="app-reading-copy">
      ...
      <Card className="app-shell-panel">
        <CardHeader>
          <CardTitle className="app-heading-section">快捷操作</CardTitle>
          <CardDescription className="app-reading-copy">把常用入口和新手最容易上手的开书方式放在一起。</CardDescription>
        </CardHeader>
        <CardContent className="app-action-row">
          <Button asChild>
            <Link to={DIRECTOR_CREATE_LINK}>AI 自动导演开书</Link>
          </Button>
          <Button asChild variant="outline">
      ...
      <Card className="app-shell-panel">
        <CardHeader>
          <CardTitle className="app-heading-section">最近项目</CardTitle>
          <CardDescription className="app-reading-copy">这里不只显示标题，也直接显示当前所处阶段和恢复入口。</CardDescription>
        </CardHeader>
        <CardContent>
          {novelQuery.isPending ? (
            ...
            <div className="app-state-panel-muted rounded-[14px] p-4 text-sm text-muted-foreground">
              暂无小说项目，先从“新建小说”开始。
            </div>
          ) : (
            <div className="grid gap-3 md:grid-cols-2">
                    ...
                    <CardHeader className="space-y-3">
                      <div className="flex items-start justify-between gap-2">
                        <div className="space-y-2">
                          <CardTitle className="line-clamp-1 text-[1.05rem] leading-snug">{novel.title}</CardTitle>
                          <div className="flex flex-wrap items-center gap-2">
                            {workflowBadge ? (
