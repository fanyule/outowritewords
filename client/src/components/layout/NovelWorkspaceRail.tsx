  ...
  return (
    ...
    >
      <div className="flex h-[calc(100vh-4rem)] flex-col gap-3 p-3">
        ...
        {!collapsed ? (
          <div className="app-shell-panel-soft rounded-2xl px-3 py-2 text-xs text-muted-foreground">
            ...
            <button
              ...
              className={cn(
                ...
                step.isWorkflowCurrent && step.isSelected
                  ...
                  ? "border-primary/18 bg-primary/[0.05] text-foreground"
                  : step.isSelected
                    ? "border-foreground/12 bg-foreground/[0.08] text-foreground"
                    : step.isDone
                      ? "border-emerald-400/18 bg-emerald-500/[0.05] text-foreground"
                      : "border-border/70 bg-background/80 hover:bg-primary/[0.03]",
              )}
            >
              {step.isWorkflowCurrent && !step.isSelected ? (
              ...
              <span
                className={cn(
                  ...
                  step.isWorkflowCurrent
                    ? "border border-primary/24 bg-primary/[0.14] text-foreground"
                    : step.isSelected
                    ? "border border-foreground/12 bg-foreground/[0.12] text-foreground"
                    : step.isDone
                      ? "border border-emerald-400/24 bg-emerald-500/[0.14] text-foreground"
                  ...
                  <span
                    className={cn(
                      ...
                      step.isWorkflowCurrent
                        ...
                        ? "border border-foreground/12 bg-foreground/[0.12] text-foreground"
                        : step.isDone
                          ? "border border-emerald-400/24 bg-emerald-500/[0.12] text-foreground"
                          : "bg-muted/80 text-muted-foreground",
                    )}
                  >
                    {step.statusLabel}
