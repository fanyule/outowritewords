...
const DEFAULT_APP_MAIN_CLASS_NAME =
  "h-[calc(100vh-4rem)] min-w-0 flex-1 overflow-y-auto px-4 py-5 sm:px-5 xl:px-6";
...
export default function AppLayout() {
  ...
  return (
    <div className="app-shell min-h-screen">
      ...
      />
      <div className="flex min-h-[calc(100vh-4rem)] gap-4 px-4 pb-4 pt-4 xl:gap-5 xl:px-5 xl:pb-5">
        ...
        <main
          className={useMobileFullWidthContent ? AUTO_DIRECTOR_MOBILE_CLASSES.appMain : DEFAULT_APP_MAIN_CLASS_NAME}
        >
          <DesktopModelSetupGate />
          <div className="app-shell-panel min-h-full overflow-hidden">
            <div className="app-shell-grid min-h-full overflow-y-auto">
              <Suspense fallback={<AppRouteFallback />}>
                <Outlet />
              </Suspense>
            </div>
