...
function shellClass(mode: AITakeoverMode): string {
  switch (mode) {
    case "loading":
      return "app-state-panel-muted";
    case "failed":
      return "app-state-panel-danger";
    case "action_required":
      return "app-warning-panel";
    case "waiting":
      return "app-warning-panel";
    case "running":
    default:
...
function progressShellClass(mode: AITakeoverMode): string {
  switch (mode) {
    case "loading":
      return "border border-border/60 bg-background/45";
    case "failed":
      return "border border-destructive/20 bg-destructive/[0.04]";
    case "action_required":
      return "border border-[color:var(--app-warning-border)] bg-background/45";
    case "waiting":
      return "border border-[color:var(--app-warning-border)] bg-background/45";
    case "running":
    default:
      return "border border-primary/15 bg-background/50 shadow-sm";
  }
}
...
export default function AITakeoverContainer({
  ...
  return (
    <div className={cn("space-y-4 rounded-3xl p-4 sm:p-5", shellClass(mode))}>
