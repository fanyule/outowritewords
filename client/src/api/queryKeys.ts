export const queryKeys = {
  ...
  account: {
    center: ["account", "center"] as const,
  },
  billing: {
    plans: ["billing", "plans"] as const,
    orderStatus: (orderId: string, mode: string) => ["billing", "order-status", orderId, mode] as const,
  },
  novels: {
    all: ["novels"] as const,
    ...
    instantGraph: (id: string) => ["novels", "graph", "instant", id] as const,
    preciseGraph: (id: string) => ["novels", "graph", "precise", id] as const,
    preciseGraphReadiness: (id: string) => ["novels", "graph", "precise-readiness", id] as const,
    preciseGraphStatus: (id: string) => ["novels", "graph", "precise-status", id] as const,
  ...
  settings: {
    ...
    graphEngineRuntime: ["settings", "graph-engine-runtime"] as const,
    graphEngineRuntimeReadiness: ["settings", "graph-engine-runtime-readiness"] as const,
