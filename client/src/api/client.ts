...
import { clearStoredAuthSession, getStoredSessionToken, redirectToLogin } from "@/lib/authSession";
...
apiClient.interceptors.response.use(
  ...
  (error: AxiosError<ApiResponse<unknown>>) => {
    ...
    const isAuthSessionRequest = requestUrl.startsWith("/auth/login")
      || requestUrl.startsWith("/auth/session")
